...
ACLOCAL = ${SHELL} /root/ovs/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AR = ar
AUTOCONF = ${SHELL} /root/ovs/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/ovs/build-aux/missing autoheader
AUTOM4TE = ${SHELL} /root/ovs/build-aux/missing autom4te
AUTOMAKE = ${SHELL} /root/ovs/build-aux/missing automake-1.15
AWK = mawk
CAPNG_LDADD = 
...
LT_REVISION = 0
LT_SYS_LIBRARY_PATH = 
MAKEINFO = ${SHELL} /root/ovs/build-aux/missing makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
MSVC64_LDFLAGS = 
MSVC_CFLAGS = 
...
PACKAGE_STRING = openvswitch 2.6.2
...
abs_builddir = /root/ovs
abs_srcdir = /root/ovs
abs_top_builddir = /root/ovs
abs_top_srcdir = /root/ovs
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/ovs/build-aux/install-sh
